...
<html lang="en" class="fullscreen-bg">
	<head>
		...
		<link
			rel="stylesheet"
			href="<?= base_url(); ?>assets/vendor/linearicons/style.css"
		/>
		<!-- MAIN CSS -->
		...
		<!-- GOOGLE FONTS -->
		<link
			href="<?= base_url(); ?>https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700"
			rel="stylesheet"
		/>
		<!-- ICONS -->
		<link
							...
							<div class="content">
								<div class="header">
									<div class="logo text-center">
										<img
											src="<?= base_url(); ?>assets/img/logo-dark.png"
											alt="Klorofil Logo"
										/>
									</div>
									<p class="lead">Register your account</p>
								</div>
								<form class="form-auth-small" action="<?= base_url(); ?>User_C/regist" method="POST">
